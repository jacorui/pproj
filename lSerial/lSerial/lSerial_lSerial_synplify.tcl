...
#-- add_file options
set_option -include_path {C:/pproj/lSerial/ISerial/source}
...
project -result_file {C:/pproj/lSerial/lSerial/lSerial_lSerial.edi}

#-- error message log file
project -log_file {lSerial_lSerial.srf}
